...
#     details: As a server-side plugin / mod, OPanel supports multiple Minecraft versions on several mainstream server platforms, including Paper, Folia, Fabric, Forge and NeoForge.
#     icon: 🌏
